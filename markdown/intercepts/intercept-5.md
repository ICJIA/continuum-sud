...
[**Methadone**](http://www.samhsa.gov/medication-assisted-treatment/treatment/methadone) uses a synthetic opioid agonist taken in pill, liquid, or water form once a day. An opioid agonist tricks the brain and body as if it were taking opiates, without adverse side effects in order to reduce physiological cravings and withdrawal symptoms.  First administered and monitored by a physician, it then can be obtained through an [opioid treatment program (OTP)](http://www.samhsa.gov/medication-assisted-treatment/opioid-treatment-programs) certified by the SAMHSA.[^34]  Methadone can be addictive, so it must be taken as prescribed to prevent adverse effects.[^35] 
...
**[Acamprosate](https://store.samhsa.gov/shin/content/MS974/MS974.pdf)** is a prescription drug taken orally (Campral®) that helps reduce cravings and withdrawal symptoms by normalizing alcohol-related neurochemical changes in the brain.[^40]  It targets neurochemical systems that may be biological factors of alcohol dependence.[^41]  
